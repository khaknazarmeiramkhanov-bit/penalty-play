...
export const TEAMS = [
  ...
  },
  {
    ...
    flag: "🇳🇴",
    ability: "Щупальца",
    abilityDesc: "35% — вратарь прыгает не туда на твоём ударе",
    special: true,
    priceCrystals: 7,
  },
  {
    ...
    flag: "🇸🇪",
    ability: "Берсерк",
    abilityDesc: "После твоего промаха — 60% обмануть вратаря следующим ударом",
    special: true,
    priceCrystals: 6,
  },
  {
    ...
    flag: "🇮🇪",
    ability: "Невидимка",
    abilityDesc: "25% — удар-фантом: вратарь не видит мяч",
    special: true,
    priceCrystals: 8,
  },
];
